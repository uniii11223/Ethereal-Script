...
https://raw.githubusercontent.com/yourusername/ethereal-script/main/es.jpg

🌌 代码即画布，粒子即像素

Ethereal Script 不是一个普通的Minecraft模组，而是一个面向开发者的粒子系统编程框架。我们相信，最强大的创作工具不是拖拽界面，而是一行行富有表达力的代码。

🎯 核心理念

"给开发者一支数字画笔，让想象力成为唯一的限制"
...
分享你的作品，让其他人只需一行命令就能复现：

```bash
/particle import github:username/artwork:nebula
```
